            ...
            {items.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  {hasChildren && (
                    <div
                      className={`${styles.mega} ${isOpen ? styles.megaOpen : ""} ${(item.label === "Newsroom" || item.label === "Gas" || item.label === "About us" || item.label === "Products and services") ? styles.megaAlignRight : ""}`}
                    >
                      <div className={styles.megaInner}>
                        <div className={styles.megaOverview}>
                          ...
                          <Link
                            href={item.href}
                            className={`${styles.megaOverviewBtn} ${item.label === "Products and services" ? styles.megaOverviewBtnBottom : ""}`}
                            onClick={() => {
                              setOpen(null);
                              setMobile(false);
                            }}
