  ...
  return (
    <main>
      <PageHero
        kicker="Contact"
        title="Contact"
        subtitle="Route inquiries by function. Keep trading and project channels distinct. Avoid collecting sensitive information via the website."
        ...
        <div className="container">
          ...
          <div className="grid-2">
            <div className="card">
              ...
              <div className="muted" style={{ marginTop: 8 }}>{site.emails.projects}</div>
              <div className="hr" style={{ background: "rgba(15,23,42,0.10)" }} />
            ...
            <div className="card">
              ...
              <form style={{ display:"grid", gap: 10, marginTop: 14 }} onSubmit={(e) => { e.preventDefault(); alert("Template form: connect to backend before production."); }}>
